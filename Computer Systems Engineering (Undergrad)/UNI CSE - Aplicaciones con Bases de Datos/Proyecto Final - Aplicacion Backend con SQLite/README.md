...
| Profesor    | JAFH                                           |
| Integrante  | JFR                                            |
| Rol         | JFR - Desarrollador Principal                  |
| Matrícula   | 100011                                         |
...
- **Node.js** v24.16.0 LTS (requerido para `--env-file` & instalación de dependencias)
- **npm** 11.13.0
...
git sparse-checkout set "Computer Systems Engineering (Undergrad)/UNI CSE - Aplicaciones con Bases de Datos/Proyecto Final - Aplicacion Backend con SQLite"
